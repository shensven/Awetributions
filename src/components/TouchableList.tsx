    ...
    <TouchableRipple rippleColor={PaperColors.ripple} onPress={onPress}>
      <View style={styles.item}>
        ...
        <View style={styles.item_right}>
          <Text style={[styles.item_right_preferenceValue, {color: PaperColors.placeholder}]}>{preferenceValue}</Text>
          <Icon name="chevron-forward" size={18} color={PaperColors.placeholder} style={styles.item_right_icon_fixed} />
        </View>
      </View>
    </TouchableRipple>
  );
