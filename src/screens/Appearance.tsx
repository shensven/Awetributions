...
const Appearance: React.FC = () => {
  ...
  return (
    ...
    <View>
      ...
      <Checkbox status={appAppearanceIndex === 2 ? 'checked' : 'unchecked'} onPress={() => _handleAppearance('dark')} />
      <Text style={{color: PaperColor.text}}>{t('Appearance.Automatic')}</Text>
      <Checkbox
        status={appAppearanceIndex === 3 || appAppearanceIndex === 4 ? 'checked' : 'unchecked'}
