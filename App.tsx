...
import {NavigationDark, NavigationLight, PaperDark, PaperLight} from './src/util/appearance/default';
    ...
    <PaperProvider theme={awetributionsPaperTheme()}>
      <SafeAreaProvider>
        <NavigationContainer
          ...
          <StatusBar
            barStyle={awetributionsNavigationTheme() === NavigationDark ? 'light-content' : 'dark-content'}
